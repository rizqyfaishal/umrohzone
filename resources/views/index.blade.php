    ...
    <div class="promo-section">
        <div class="container">
            ...
            <div class="row">
                ...
                @foreach(array_combine($pakets,$promos) as $paket => $promo)
                <div class="col-sm-3">
                    <p>{{App\Hotel::find($paket->hotel_mekah_id)->nama}}</p>
                    <p>{{App\Pesawat::find($paket->pesawat_id)->nama}} </p>

                    <p>
                        <span class="price discount">{{$paket->harga}}</span>
                        <span class="price">{{$promo->price}}</span>
                    </p>

                    <p>
                        <span class="price message">Pesan s/d {{$promo->due_date}}</span>
                    </p>
                </div>
                @endforeach
            </div>
